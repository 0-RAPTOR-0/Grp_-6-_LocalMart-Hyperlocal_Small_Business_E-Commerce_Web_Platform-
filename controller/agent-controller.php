...
if (empty($errors)) {
    ...
    $saved = registerUser($conn, $fullname, $email, $password, 'delivery_agent', $phone, $vehicleNote);
    ...
    if ($saved) {
        ...
        echo '<p><a href="../Pages/agent-register.html">Go back</a></p>';
    }
    ...
    echo "</ul>";
    echo '<p><a href="../Pages/agent-register.html">Go back and try again</a></p>';
}

} else {

    echo "Please fill out the registration form first.";
    echo '<p><a href="../Pages/agent-register.html">Go to Delivery Agent Registration</a></p>';
}
